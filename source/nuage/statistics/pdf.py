...
plotly.offline.plot(fig, filename=figure_file_path + 'ex_pdf_adherence_diff.html', auto_open=False, show_link=True)
plotly.io.write_image(fig, figure_file_path + 'ex_pdf_adherence_diff.png')
plotly.io.write_image(fig, figure_file_path + 'ex_pdf_adherence_diff.pdf')
